            ...
            <div class="row">
                ...
                <div class="col-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-8"><input type="password" name="password" class="form-control" required></div>
                    </div>
                <div class="col-3"></div>
                <div class="col-12 text-center">
                    <br>
                    <p>If your are not registered, please <a href="<?php echo base_url('site/registration'); ?>">click</a> here for registration</p>
