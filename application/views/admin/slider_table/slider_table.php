        ...
        <div class="container-fluid">
            <div class="card shadow">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0 text-center">স্লাইডার তালিকা</h5>
                </div>
                            ...
                            <tbody>
                                ...
                                foreach ($image_slider as $row): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <form action="<?= base_url('update_slider_status/' . $row->id); ?>" method="post">
...
<?php $this->load->view('admin/slider_table/slider_create_popup'); ?>
...
<script>
    ...
    $.ajax({
        url: "<?= base_url('home_Page_managment_controller/update_slider'); ?>",
    type: "POST",
    data: $(this).serialize(),
    ...
    $(document).ready(function () {
        $('.open-charge-modal').on('click', function () {
            ...
            if ($('#chargeModal input[name="slider_id"]').length === 0) {
                ...
                $('#chargeModal input[name="slider_id"]').val(id);
            }
